...
namespace DTO.Utils
{
    public static class DoubleExtesions
    {
        ...
        public static string ToPtBR(this double me) => me.ToString("#,###,##0.00", CultureInfo.GetCultureInfo("pt-BR"));
        public static string ToPtBR(this double? me) => me.HasValue ? me.Value.ToString("#,###,##0.00", CultureInfo.GetCultureInfo("pt-BR")) : "";

        public static string DinheiroExtenso(this double? valor) => valor.HasValue ? valor.Value.DinheiroExtenso() : "";
        public static string DinheiroExtenso(this double valor)
        {
            string strValor = valor.ToString("000000000000000.00");
            string valor_por_extenso = string.Empty;
            for (int i = 0; i <= 15; i += 3)
            {
                valor_por_extenso += Escrever_Valor_Extenso(Convert.ToDouble(strValor.Substring(i, 3)));
...
| valor_por_extenso.Substring(valor_por_extenso.Length - 8, 7) == "TRILHÕES")
        ...
        public static string Escrever_Valor_Extenso(this double valor)
        {
            if (valor <= 0)
                return string.Empty;
            else
